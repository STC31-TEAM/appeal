...
comment on COLUMN companies.id_map_role is 'Foreign key к таблице набора ролей пользователя MapRoles';
...
comment on COLUMN companies.id_user is 'FK к ID табл USERS — представитель компании';
